...
final List<ExamplePageSpec> quickjsUiGettingStartedExamplePages = [
  _page(
...
final List<ExamplePageSpec> quickjsUiFoundationExamplePages = [
  _page(
  ...
  _page(
    ...
    description:
        '演示 scrollTo key/offset、drag/swipe、SingleChildScrollView 和 keyed 列表项过渡。',
    tags: const ['scroll', 'transition'],
  ...
  _page(
    ...
    tags: const ['input', 'decoration', 'overlay'],
...
// Repository rule: newly created demos are appended to this catalog group.
