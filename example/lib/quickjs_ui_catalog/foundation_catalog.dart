...
final List<ExamplePageSpec> quickjsUiFoundationExamplePages = [
  ...
  quickjsUiPageSpec(
    ...
    builder: (_) => const QuickjsUiDecorationEffectsPage(),
  ),
  quickjsUiPageSpec(
    category: ExampleCategory.uiFoundation,
    title: '输入事件 · 鼠标、指针与键盘',
    ...
    builder: (_) => const QuickjsUiPointerKeyboardEventsPage(),
  ),
  quickjsUiPageSpec(
    category: ExampleCategory.uiFoundation,
    title: '表单控件 · 状态与实时预览',
    ...
    builder: (_) => const QuickjsUiFormControlsPage(),
  ),
  quickjsUiPageSpec(
    category: ExampleCategory.uiFoundation,
    ...
    builder: (_) => const QuickjsUiFeedbackOverlaysPage(),
  ),
  quickjsUiPageSpec(
    category: ExampleCategory.uiFoundation,
    title: '滚动控制 · 定位与嵌套区域',
  ...
  quickjsUiPageSpec(
    ...
    builder: (_) => const QuickjsUiKeyedListTransitionsPage(),
  ),
  quickjsUiPageSpec(
    category: ExampleCategory.uiFoundation,
    title: '基础动画 · 独立隐式过渡',
    ...
    builder: (_) => const QuickjsUiImplicitAnimationsPage(),
  ),
  quickjsUiPageSpec(
    category: ExampleCategory.uiFoundation,
    title: '控件系统 · 状态与结构插槽',
  ...
  quickjsUiPageSpec(
    ...
    builder: (_) => const QuickjsUiTemperatureChartPage(),
  ),
];
