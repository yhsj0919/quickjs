...
final List<ExamplePageSpec> jsUiScenarioExamplePages = [
  jsUiPageSpec(
  ...
  jsUiPageSpec(
    ...
    builder: (_) => const JsUiProfileFormPage(),
  ),
  jsUiPageSpec(
    category: ExampleCategory.scenario,
    kind: ExampleKind.scenario,
    ...
    builder: (_) => const JsUiWeatherBackgroundPage(),
  ),
];
