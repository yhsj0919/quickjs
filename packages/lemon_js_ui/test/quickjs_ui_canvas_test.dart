...
import 'package:lemon_js_ui/src/renderer/quickjs_ui_canvas_scene.dart';
...
void main() {
  testWidgets('retained Canvas scene survives renderer replacement', (
    ...
    await tester.pumpWidget(MaterialApp(home: first.build(registered)));
    ...
    await tester.pumpWidget(MaterialApp(home: second.build(reused)));
