...
import 'callback_codec.dart';

const String dartStreamWireType = 'dartStream';

Map<String, Object?> encodeDartStreamWire(int streamId) {
  return {'__quickjsType': dartStreamWireType, 'streamId': streamId};
}
...
final class JsDartStreamRegistry {
  JsDartStreamRegistry(this._onPullResponse, this._onPullError);
...
final class JsJsSinkRegistry {
  JsJsSinkRegistry(this._onActionComplete, this._onActionError);
