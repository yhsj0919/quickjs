...
abstract final class JsDiag {
  static bool enabled = false;

  static final Map<String, _JsDiagBucket> _buckets = <String, _JsDiagBucket>{};
  ...
  static void count(String channel, {String? detail}) {
    ...
    final bucket = _buckets.putIfAbsent(channel, _JsDiagBucket.new);
    bucket.count += 1;
    if (detail != null) {
