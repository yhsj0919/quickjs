...
- [x] 支持生命周期事件：页面进入/返回时向 JSUI 派发 `onRouteEnter`、`onRouteResult`、`onRouteLeave`
  或等价事件。
...
- [x] 0.3.1 收尾：导航互通、宿主策略、route result、route lifecycle、Flutter route transition、示例页和文档已同步；
